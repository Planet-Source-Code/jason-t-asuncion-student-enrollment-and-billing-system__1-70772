...
cn.Execute "insert into income (Or_number,Date_of_Receipt,Particulars,Amount) Values ('" & Text1.Text & "','" & DTPicker1 & "','" & Text3.Text & "','" & Text2.Text & "')"
